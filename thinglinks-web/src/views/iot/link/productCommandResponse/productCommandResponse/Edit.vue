...
<script lang="ts">
  ...
  import { Api, save, update } from '/@/api/iot/link/productCommandResponse/productCommandResponse';
  import { getValidateRules } from '/@/api/thinglinks/common/formValidateService';
  import { customFormSchemaRules, editFormSchema } from './productCommandResponse.data';
  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      const [registerForm, { setFieldsValue, resetFields, updateSchema, validate, resetSchema }] =
        useForm({
          name: 'ProductCommandResponseEdit',
          labelWidth: 100,
