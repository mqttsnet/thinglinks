...
/** trace 统计（后端 SQL 聚合） */
export const stats = (params: PageParams<BridgeExecutionTracePageQuery>) =>
  defHttp.request<BridgeExecutionTraceStatsResultVO>({ ...Api.Stats, params });
...
export const replay = (traceId: string) => defHttp.request<string>({ ...Api.Replay(traceId) });
