        ...
        >
          <div class="card_wrap">
            <div class="left_info">
              ...
              <div class="btns">
                <div class="btn" v-hasAnyPermission="['video:device:info:delete']">
                ...
                <div class="btn" v-hasAnyPermission="['video:device:info:edit']">
                ...
                <div class="btn" v-hasAnyPermission="['video:device:channel']">
                  <a-tooltip placement="top" :title="t('video.device.info.channel')">
                    <img
                      alt=""
            ...
            <img
              ...
              src="/@/assets/images/video/device/info/video-device-info.svg"
              alt=""
...
<script setup lang="ts">
  ...
  import EditModal from '/@/views/video/device/info/Edit.vue';
