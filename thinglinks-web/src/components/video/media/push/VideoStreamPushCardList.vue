      ...
      <a-row v-if="dataList.length > 0" :gutter="[24, 12]">
        ...
        >
          <div class="card_wrap">
            <div class="left_info">
              <div class="item">
                <a-tooltip placement="top" :title="record.streamIdentification || '未命名'">
                  <div class="name">{{ record.streamIdentification || '未命名' }}</div>
                </a-tooltip>
              </div>
              <a-row :gutter="[4, 0]">
                <a-col :span="12">
              ...
              <div class="btns">
                <div class="btn" v-hasAnyPermission="['video:media:push:delete']">
            ...
            <img
              ...
              src="/@/assets/images/video/media/push/video-stream-push.svg"
              alt=""
...
<script setup lang="ts">
  ...
  import { page, deleteSingle } from '/@/api/video/media/push';
  import EditModal from '/@/views/video/media/push/Edit.vue';
