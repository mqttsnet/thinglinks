        ...
        >
          ...
          >
            <div class="product-info">
              ...
              <a-tooltip placement="top" :title="record.channelName">
                <div class="title">{{ record.channelName }}</div>
              </a-tooltip>
              <div class="props">
                <div class="prop">
                  <div class="label">{{ t('iot.link.engine.alarmRecord.alarmChannel') }}</div>
                  <div class="value">{{
            ...
            <div class="product-img channel-card-img">
              <img
...
<script lang="ts">
  ...
  import EditModal from '/@/views/iot/rule/alarm/channel/Edit.vue';
