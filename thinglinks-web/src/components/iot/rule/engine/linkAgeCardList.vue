        ...
        >
          ...
          >
            <div class="product-info">
              <div class="status">{{
                getDictLabel('RULE_CONDITION_STATUS', record.status + '', '')
              }}</div>
              <a-tooltip placement="top" :title="record.ruleName">
                <div class="title">{{ record.ruleName }}</div>
              </a-tooltip>
              <div class="props">
                <div class="prop">
                  <div class="label">{{ t('iot.link.engine.linkage.ruleIdentification') }}</div>
                  <div class="value" :title="record.ruleIdentification">{{
                    record.ruleIdentification
                  }}</div>
                </div>
                <div class="prop">
                  <div class="label">{{ t('iot.link.engine.linkage.createdTime') }}</div>
                  <div class="value">{{ record.createdTime }}</div>
                </div>
                <!-- <div class="prop">
                  <div class="label">规则描述</div>
                  <div class="value">{{ record.remark }}</div>
                </div> -->
              </div>
              <div class="btns">
                <div class="btn">
...
<script lang="ts">
  ...
  // api
  import { page, remove, deleteSingle } from '/@/api/iot/rule/engine/linkage/linkage';
  // components
  import {
    Card,
    Row,
  ...
  import EditModal from '/@/views/iot/rule/engine/linkage/Edit.vue';
  import { useMessage } from '/@/hooks/web/useMessage';
  import { useDrawer } from '/@/components/Drawer';
  import executionLogDetail from '/@/views/iot/rule/engine/linkage/executionLog/detail.vue';
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      // 查看执行日志
      function openDetailDrawer(record: Recordable, e: Event) {
        e?.stopPropagation();
        openDetail(true, {
