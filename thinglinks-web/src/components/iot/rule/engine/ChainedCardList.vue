        ...
        >
          ...
          >
            <div class="product-info">
              <div class="status">{{
                getDictLabel('RULE_INSTANCE_STATUS', record.status + '', '')
              }}</div>
              ...
              <div class="props">
                <div class="prop">
                  <div class="label">{{ t('iot.link.engine.chained.appId') }}</div>
                  <div class="value">{{ record.appId }}</div>
                </div>
                <div class="prop">
                  <div class="label">{{ t('iot.link.engine.chained.type') }}</div>
                  <div class="value">{{
...
<script lang="ts">
  ...
  import EditModal from '/@/views/iot/rule/engine/chained/Edit.vue';
