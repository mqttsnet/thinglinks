...
INSERT INTO `base_dict` (`id`, `parent_id`, `parent_key`, `dict_group`, `key_`, `classify`, `data_type`, `name`, `state`, `remark`, `sort_value`, `icon`, `css_style`, `css_class`, `prop_type`, `i18n_json`, `created_by`, `created_time`, `updated_by`, `updated_time`, `created_org_id`) VALUES (502678509857846275, 502678509857846274, 'TENANT_AMAP__AAPPLICATION_JS_API_KEY', NULL, 'key', '10', '1', '874b1b7b84870078d7bc36b99b70eeff', b'1', 'KEY', 1, '', '', '', '', '{\"zh-CN\": \"874b1b7b84870078d7bc36b99b70eeff\", \"en-US\": \"874b1b7b84870078d7bc36b99b70eeff\", \"ja\": \"874b1b7b84870078d7bc36b99b70eeff\"}', 1452186486253289472, '2024-06-05 16:03:18', 1452186486253289472, '2024-06-11 22:04:39', NULL);
INSERT INTO `base_dict` (`id`, `parent_id`, `parent_key`, `dict_group`, `key_`, `classify`, `data_type`, `name`, `state`, `remark`, `sort_value`, `icon`, `css_style`, `css_class`, `prop_type`, `i18n_json`, `created_by`, `created_time`, `updated_by`, `updated_time`, `created_org_id`) VALUES (502678509857846276, 502678509857846274, 'TENANT_AMAP__AAPPLICATION_JS_API_KEY', NULL, 'securityJsCode', '10', '1', 'ef9027c04d8569eb8b7044eabf0fe3cc', b'1', '安全密钥', 1, '', '', '', '', '{\"zh-CN\": \"ef9027c04d8569eb8b7044eabf0fe3cc\", \"en-US\": \"ef9027c04d8569eb8b7044eabf0fe3cc\", \"ja\": \"ef9027c04d8569eb8b7044eabf0fe3cc\"}', 1452186486253289472, '2024-06-05 16:04:03', 1452186486253289472, '2024-06-11 22:04:47', NULL);
...
CREATE TABLE `rule_bridge_execution_trace` (
                                               ...
                                               `created_org_id` bigint DEFAULT NULL COMMENT '创建人组织',
                                               PRIMARY KEY (`id`) USING BTREE,
                                               UNIQUE KEY `uk_trace_rule` (`trace_id`,`bridge_rule_id`) USING BTREE COMMENT '同一 envelope 命中多规则按 (traceId, ruleId) 唯一;RocketMQ 重投同 envelope 同规则被拦截',
...
CREATE TABLE `video_channel` (
                                 `id` bigint NOT NULL COMMENT '主键',
                                 `device_identification` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '所属设备标识',
                                 `channel_identification` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '通道标识',
                                 `channel_no` int DEFAULT NULL COMMENT '逻辑通道号',
                                 `channel_type` smallint DEFAULT NULL COMMENT '通道类型(GB28181行业编码131~143)',
                                 `channel_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '通道名称',
                                 `stream_identification` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '流标识',
                                 `stream_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '流类型',
                                 `manufacturer` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '厂商',
                                 `model` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '型号',
                                 `online_status` tinyint(1) DEFAULT '0' COMMENT '在线状态(0=离线/1=在线)',
                                 `host` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '通道地址(IP/域名)',
                                 `port` int DEFAULT NULL COMMENT '端口',
                                 `password` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '设备口令',
                                 `longitude` decimal(12,8) DEFAULT NULL COMMENT '经度',
                                 `latitude` decimal(12,8) DEFAULT NULL COMMENT '纬度',
                                 `full_address` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '安装地址',
                                 `province_code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '省级编码',
                                 `city_code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '市级编码',
                                 `region_code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '行政区划编码',
                                 ...
                                 `extend_params` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '扩展参数',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='统一通道表';
...
CREATE TABLE `video_device` (
                                `id` bigint NOT NULL COMMENT '主键',
                                `device_identification` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '设备标识',
                                `access_protocol` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '设备接入协议(GB28181/ONVIF/ISUP/JT1078/SIP/PELCO_D/PELCO_P)',
                                `device_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '设备名称',
                                `custom_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '自定义名称',
                                `manufacturer` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '厂商',
                                `model` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '型号',
                                `firmware` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '固件版本',
                                `host` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '设备地址(IP/域名)',
                                `port` int DEFAULT NULL COMMENT '端口',
                                `wan_host` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '公网地址(IP/域名)',
                                `lan_host` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '局域网地址(IP/域名)',
                                `access_endpoint` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '完整访问端点(host:port)',
                                `sdp_host` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '收流地址(IP/域名)',
                                `local_host` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '本地SIP交互地址(IP/域名)',
                                `transport` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '传输协议(UDP/TCP)',
                                `stream_mode` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '数据流传输模式',
                                `online_status` tinyint(1) DEFAULT '0' COMMENT '是否在线(0=离线/1=在线)',
                                `register_time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '注册时间',
                                `last_keepalive_time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '最后心跳时间',
                                ...
                                `auth_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '认证方式(PASSWORD/VALIDATE_CODE/AUTH_TOKEN/CERTIFICATE/DIGEST/NONE)',
                                `auth_secret` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '认证密钥(加密存储)',
                                `media_identification` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '媒体服务唯一标识',
                                `channel_count` int DEFAULT '0' COMMENT '通道数量',
                                `ability` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '设备能力集描述',
                                ...
                                KEY `idx_created_org_id` (`created_org_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='统一设备表';
...
CREATE TABLE `video_device_alarm` (
                                      `id` bigint NOT NULL COMMENT '主键',
                                      `device_identification` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '设备国标编号',
                                      `channel_identification` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '通道国标编号',
                                      ...
                                      `alarm_description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '告警描述',
                                      `alarm_type` tinyint DEFAULT NULL COMMENT '告警类型',
                                      `alarm_type_param` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '告警类型参数(JSON)',
                                      ...
                                      `handle_time` datetime DEFAULT NULL COMMENT '处理时间',
                                      `handle_result` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '处理结果/备注',
                                      ...
                                      KEY `idx_created_org_id` (`created_org_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='视频设备告警表';
...
CREATE TABLE `video_device_group` (
                                      ...
                                      `group_path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '层级路径(如: /1/2/3，便于快速查子孙)',
                                      `group_level` int NOT NULL DEFAULT '1' COMMENT '层级深度(从1开始)',
                                      `icon` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '图标标识',
                                      `enable` tinyint(1) NOT NULL DEFAULT '1' COMMENT '启用状态(0=禁用/1=启用)',
                                      `extend_params` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '扩展参数(JSON)',
                                      ...
                                      KEY `idx_created_org_id` (`created_org_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='视频设备分组表';
...
CREATE TABLE `video_device_group_relation` (
                                               ...
                                               `device_identification` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '设备国标编号',
                                               `channel_identification` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '通道国标编号(空表示设备级别关联)',
                                               ...
                                               `updated_by` bigint DEFAULT NULL COMMENT '更新人',
                                               PRIMARY KEY (`id`) USING BTREE,
                                               UNIQUE KEY `uk_group_device_channel` (`group_id`,`device_identification`,`channel_identification`) USING BTREE,
                                               KEY `idx_group_id` (`group_id`) USING BTREE,
                                               KEY `idx_device_identification` (`device_identification`) USING BTREE,
                                               KEY `idx_created_org_id` (`created_org_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='视频设备分组关联表';
...
CREATE TABLE `video_device_mobile_position` (
                                                ...
                                                `geo_coord_sys` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'WGS84' COMMENT '坐标系(WGS84/GCJ02/BD09)',
                                                `created_org_id` bigint DEFAULT NULL COMMENT '所属组织ID',
                                                `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除(0=正常/1=删除)',
                                                `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                                `created_by` bigint DEFAULT NULL COMMENT '创建人',
                                                ...
                                                KEY `idx_created_org_id` (`created_org_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='视频设备移动位置表';
...
CREATE TABLE `video_gateway_mapping` (
                                         `id` bigint NOT NULL COMMENT '主键',
                                         `src_protocol` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '源协议(JT1078/ISUP等)',
                                         `src_device_identification` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '源设备标识',
                                         `src_channel_identification` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '源通道标识',
                                         `gb_device_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '映射GB28181设备编号',
                                         `gb_channel_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '映射GB28181通道编号',
                                         ...
                                         `last_register_time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '最后注册时间',
                                         `remark` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '备注',
                                         `created_org_id` bigint DEFAULT NULL COMMENT '创建人组织',
                                         `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除(0=正常/1=删除)',
                                         `created_by` bigint DEFAULT NULL COMMENT '创建人',
                                         ...
                                         `updated_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
                                         PRIMARY KEY (`id`) USING BTREE,
                                         UNIQUE KEY `uk_src_device_channel` (`src_protocol`,`src_device_identification`,`src_channel_identification`) USING BTREE,
                                         ...
                                         KEY `idx_created_org_id` (`created_org_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='网关协议映射表';
...
CREATE TABLE `video_notify_subscription` (
                                             ...
                                             `channel_config` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '渠道凭证(JSON)',
...
CREATE TABLE `video_platform` (
                                  `id` bigint NOT NULL COMMENT '主键',
                                  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '平台名称',
                                  `enable` tinyint(1) DEFAULT '1' COMMENT '启用状态(0=禁用/1=启用)',
                                  `server_gb_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '平台国标编号',
                                  `server_gb_domain` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '平台国标域',
                                  ...
                                  `device_gb_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '本平台在上级的设备编号',
                                  ...
                                  `username` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '认证用户名',
                                  `password` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '认证密码',
                                  `expires` int DEFAULT '3600' COMMENT '注册有效期(秒)',
                                  `keep_timeout` int DEFAULT '60' COMMENT '心跳超时(秒)',
                                  `transport` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'UDP' COMMENT '传输协议(UDP/TCP)',
                                  `character_set` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'GB2312' COMMENT '字符集(GB2312/UTF-8)',
                                  ...
                                  `civil_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '行政区划编码',
                                  `manufacturer` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '厂商',
                                  ...
                                  `secrecy` tinyint DEFAULT '0' COMMENT '保密属性(0=不涉密/1=涉密)',
                                  `server_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '服务器ID',
                                  `cascade_type` tinyint DEFAULT '0' COMMENT '级联类型(0=作为下级/1=作为上级)',
                                  `gb_version` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'GB28181协议版本',
                                  `online_status` tinyint(1) DEFAULT '0' COMMENT '在线状态(0=离线/1=在线)',
                                  ...
                                  `last_register_time` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '最近注册时间',
                                  `last_keepalive_time` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '最近心跳时间',
                                  ...
                                  `hook_url_prefix` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Hook URL前缀',
                                  `service_instance_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '服务实例ID',
                                  ...
                                  KEY `idx_enable` (`enable`) USING BTREE,
                                  KEY `idx_created_org_id` (`created_org_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='视频级联平台表';
...
CREATE TABLE `video_platform_catalog` (
                                          ...
                                          `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '目录名称',
                                          `gb_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '目录国标编号',
                                          ...
                                          KEY `idx_parent_id` (`parent_id`) USING BTREE,
                                          KEY `idx_created_org_id` (`created_org_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='视频级联目录表';
...
CREATE TABLE `video_platform_channel` (
                                          ...
                                          `device_identification` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '设备国标编号',
                                          `channel_identification` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '通道国标编号',
                                          `custom_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '自定义名称',
                                          `custom_gb_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '自定义国标编号',
                                          `created_org_id` bigint DEFAULT NULL COMMENT '所属组织ID',
                                          `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除(0=正常/1=删除)',
                                          `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                          `created_by` bigint DEFAULT NULL COMMENT '创建人',
                                          ...
                                          KEY `idx_device_identification` (`device_identification`) USING BTREE,
                                          KEY `idx_created_org_id` (`created_org_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='视频级联平台通道关联表';
...
CREATE TABLE `video_record_file` (
                                     ...
                                     `device_identification` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '设备国标编号',
                                     `channel_identification` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '通道国标编号',
                                     `stream_identification` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '流标识',
                                     `app` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '应用名',
                                     `media_identification` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '流媒体服务器标识',
                                     ...
                                     `file_format` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'mp4' COMMENT '文件格式(mp4/flv/ts)',
                                     ...
                                     KEY `idx_media_identification` (`media_identification`) USING BTREE,
                                     KEY `idx_created_org_id` (`created_org_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='视频录像文件表';
...
CREATE TABLE `video_record_plan` (
                                     ...
                                     `media_identification` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '指定流媒体服务器标识(空则自动分配)',
                                     `record_format` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'mp4' COMMENT '录像格式(mp4/flv/ts)',
                                     ...
                                     `storage_path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '存储路径(空则用默认路径)',
                                     `plan_status` tinyint NOT NULL DEFAULT '0' COMMENT '计划状态(0=停用/1=启用)',
                                     `schedule_rule` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '调度规则(JSON，支持周期/CRON/一次性)',
                                     `extend_params` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '扩展参数(JSON)',
                                     `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '备注',
                                     `created_org_id` bigint DEFAULT NULL COMMENT '所属组织ID',
                                     `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '逻辑删除(0=正常/1=删除)',
                                     ...
                                     KEY `idx_created_org_id` (`created_org_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='视频录像计划表';
