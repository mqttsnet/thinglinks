package com.mqttsnet.thinglinks.vo.save.script;
...
@EqualsAndHashCode
@Builder
@Schema(title = "RuleGroovyScriptSaveVO", description = "规则脚本表")
public class RuleGroovyScriptSaveVO implements Serializable {
