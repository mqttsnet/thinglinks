...
import com.mqttsnet.thinglinks.generator.config.ControllerConfig;
...
import com.mqttsnet.thinglinks.generator.config.ManagerConfig;
import com.mqttsnet.thinglinks.generator.config.MapperConfig;
import com.mqttsnet.thinglinks.generator.config.PackageInfoConfig;
 ...
 * @create [2022/4/8 12:37 PM ] [mqttsnet] [初始创建]
 */
public class OutputFileUtils {
     ...
     * @create [2022/4/8 12:45 PM ] [mqttsnet] [初始创建]
     */
    ...
    /**
     * 获取 thinglinks-web-max 项目的文件生成路径
     *
     * @param genTable     表配置
     * @param subTable     从表配置
     * @param templatePath 生成代码的模板路径
    ...
    /**
     * 获取 thinglinks-cloud / thinglinks-boot 项目的文件生成路径
     *
     ...
     * @create [2022/4/8 12:47 PM ] [mqttsnet] [初始创建]
     */
