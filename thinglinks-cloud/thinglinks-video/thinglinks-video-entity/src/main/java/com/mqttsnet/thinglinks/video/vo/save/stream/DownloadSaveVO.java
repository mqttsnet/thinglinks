...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "录像下载请求参数")
public class DownloadSaveVO implements Serializable {
    ...
    @Schema(description = "下载开始时间", required = true)
    private LocalDateTime startTime;

    @NotNull(message = "结束时间不能为空")
    @Schema(description = "下载结束时间", required = true)
    private LocalDateTime endTime;

    @Schema(description = "下载倍速（默认4倍速）", example = "4")
