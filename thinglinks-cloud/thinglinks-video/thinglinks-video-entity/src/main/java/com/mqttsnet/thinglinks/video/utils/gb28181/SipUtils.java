...
import com.mqttsnet.thinglinks.video.dto.gb28181.sip.Gb28181Sdp;
...
public class SipUtils {
    ...
    public static String parseTime(String timeStr) {
        ...
        DateTime dateTime = DateUtil.parse(timeStr, DatePattern.UTC_SIMPLE_PATTERN);
        return DateUtil.format(dateTime, DatePattern.NORM_DATETIME_FORMATTER);
    }
