package com.mqttsnet.thinglinks.video.vo.update.gateway;
...
@EqualsAndHashCode
@Builder
@Schema(title = "VideoGatewayMappingUpdateVO", description = "视频网关映射")
public class VideoGatewayMappingUpdateVO implements Serializable {
