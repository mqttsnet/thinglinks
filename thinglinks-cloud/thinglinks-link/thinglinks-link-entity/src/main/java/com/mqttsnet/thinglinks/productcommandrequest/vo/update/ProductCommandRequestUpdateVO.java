package com.mqttsnet.thinglinks.productcommandrequest.vo.update;
...
@EqualsAndHashCode
@Builder
@Schema(title = "ProductCommandRequestUpdateVO", description = "产品模型服务命令属性请求参数")
public class ProductCommandRequestUpdateVO implements Serializable {
