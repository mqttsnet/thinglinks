package com.mqttsnet.thinglinks.productproperty.vo.save;
...
@EqualsAndHashCode
@Builder
@Schema(title = "ProductPropertySaveVO", description = "产品模型服务属性保存VO")
public class ProductPropertySaveVO implements Serializable {
