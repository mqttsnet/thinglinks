package com.mqttsnet.thinglinks.productcommandrequest.vo.save;
...
@EqualsAndHashCode
@Builder
@Schema(title = "ProductCommandRequestSaveVO", description = "产品模型服务命令属性请求参数")
public class ProductCommandRequestSaveVO implements Serializable {
