package com.mqttsnet.thinglinks.productcommand.vo.update;
...
@EqualsAndHashCode
@Builder
@Schema(title = "ProductCommandUpdateVO", description = "产品模型设备服务命令表")
public class ProductCommandUpdateVO implements Serializable {

    private static final long serialVersionUID = 1L;

    @Schema(description = "命令id")
    @NotNull(message = "请填写命令id", groups = SuperEntity.Update.class)
    private Long id;
