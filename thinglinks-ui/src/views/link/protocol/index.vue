  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="协议标识" prop="protocolIdentification">
        <el-input
          v-model="queryParams.protocolIdentification"
          placeholder="请输入协议标识"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="协议类型 ：mqtt || coap || modbus || http" prop="protocolType">
        <el-select v-model="queryParams.protocolType" placeholder="请选择协议类型 ：mqtt || coap || modbus || http" clearable size="small">
          <el-option
      ...
      <el-form-item label="协议语言" prop="protocolVoice">
        <el-select v-model="queryParams.protocolVoice" placeholder="请选择协议语言" clearable size="small">
          <el-option
            v-for="dict in dict.type.link_ protocol_voice"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['link:protocol:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['link:protocol:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="protocolList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="协议语言" align="center" prop="protocolVoice">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.link_ protocol_voice" :value="scope.row.protocolVoice"/>
        </template>
      </el-table-column>
