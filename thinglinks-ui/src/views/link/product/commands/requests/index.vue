<template>
  <div class="app-container">
    <el-form v-if="false" v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="68px" size="small">
...
<!--      </el-form-item>-->
      <el-form-item label="参数名字" prop="parameterName">
        <el-input
          ...
          clearable
          placeholder="请输入命令中参数的名字"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="参数描述" prop="parameterDescription">
        <el-input
          v-model="queryParams.parameterDescription"
          clearable
          placeholder="请输入命令中参数的描述"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['link:requests:remove']"
          :disabled="multiple"
          icon="el-icon-delete"
          plain
          size="mini"
      ...
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['link:requests:export']"
