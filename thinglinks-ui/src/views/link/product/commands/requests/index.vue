<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-tooltip content="新增输入参数" effect="light" placement="top">
          <el-button v-hasPermi="['link:requests:add']" icon="el-icon-plus" circle size="mini" type="primary"
            @click="handleAdd"></el-button>
        </el-tooltip>
      </el-col>
      <el-col :span="1.5">
        <el-tooltip content="修改输入参数" effect="light" placement="top">
          <el-button v-hasPermi="['link:requests:edit']" :disabled="single" icon="el-icon-edit" circle size="mini"
            type="success" @click="handleUpdate"></el-button>
        </el-tooltip>
      </el-col>
      <el-col :span="1.5">
        <el-tooltip content="删除输入参数" effect="light" placement="top">
          <el-button v-hasPermi="['link:requests:remove']" :disabled="multiple" icon="el-icon-delete" circle size="mini"
            type="danger" @click="handleDelete"></el-button>
        </el-tooltip>
      </el-col>
      <el-col :span="1.5">
        <el-tooltip content="导出输入参数" effect="light" placement="top">
          <el-button v-hasPermi="['link:requests:export']" icon="el-icon-download" circle size="mini" type="warning"
    ...
    <el-table v-loading="loading" :data="requestsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" class-name="small-padding fixed-width" label="操作">
        <template slot-scope="scope">
          <el-button v-hasPermi="['link:requests:edit']" icon="el-icon-edit" size="mini" type="text"
            @click="handleUpdate(scope.row)">修改</el-button>
          <el-button v-hasPermi="['link:requests:remove']" icon="el-icon-delete" size="mini" type="text"
...
<script>
import { listRequests, getRequests, delRequests, addRequests, updateRequests } from "@/api/link/product/productRequests";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('link/product/commands/requests/export', {
        ...this.queryParams
