...
/**
 * {@link ReAuthFailed} 事件处理器 ── MQTT5 增强认证重协商失败,broker 断开会话.
 *
 * @author mqttsnet
 * @since 1.1
 */
public class ReAuthFailedEventProcessor extends AbstractClientEventProcessor<ReAuthFailed> {

    @Override
    protected Class<ReAuthFailed> eventClass() {
        return ReAuthFailed.class;
    }
}
