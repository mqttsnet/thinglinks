...
/**
 * {@link InvalidTopic} 事件处理器 ── 客户端发布的 topic 不符合 MQTT 规范(语义违规),broker 断连.
 *
 * @author mqttsnet
 * @since 1.1
 */
public class InvalidTopicEventProcessor extends AbstractClientEventProcessor<InvalidTopic> {

    @Override
    protected Class<InvalidTopic> eventClass() {
        return InvalidTopic.class;
    }

    @Override
    protected void enrichSubtype(Map<String, Object> data, InvalidTopic event) {
