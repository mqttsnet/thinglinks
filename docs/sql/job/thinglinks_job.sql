...
INSERT INTO `xxl_job_group` (`id`, `app_name`, `title`, `address_type`, `address_list`, `update_time`) VALUES (2, 'thinglinks-base-executor', '基础执行器', 0, NULL, '2025-11-02 16:44:43');
...
-- ----------------------------
BEGIN;
INSERT INTO `xxl_job_info` (`id`, `job_group`, `job_desc`, `add_time`, `update_time`, `author`, `alarm_email`, `schedule_type`, `schedule_conf`, `misfire_strategy`, `executor_route_strategy`, `executor_handler`, `executor_param`, `executor_block_strategy`, `executor_timeout`, `executor_fail_retry_count`, `glue_type`, `glue_source`, `glue_remark`, `glue_updatetime`, `child_jobid`, `trigger_status`, `trigger_last_time`, `trigger_next_time`) VALUES (1, 3, '测试任务', '2018-11-03 22:21:31', '2023-05-25 14:07:24', 'XXL', '', 'CRON', '0 0 0 * * ? *', 'DO_NOTHING', 'FIRST', 'demoJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2018-11-03 22:21:31', '', 1, 1761753600000, 1762099200000);
INSERT INTO `xxl_job_info` (`id`, `job_group`, `job_desc`, `add_time`, `update_time`, `author`, `alarm_email`, `schedule_type`, `schedule_conf`, `misfire_strategy`, `executor_route_strategy`, `executor_handler`, `executor_param`, `executor_block_strategy`, `executor_timeout`, `executor_fail_retry_count`, `glue_type`, `glue_source`, `glue_remark`, `glue_updatetime`, `child_jobid`, `trigger_status`, `trigger_last_time`, `trigger_next_time`) VALUES (3, 1, '刷新所有租户设备缓存', '2025-03-30 19:57:24', '2025-11-02 16:42:43', 'mqttsnet', '', 'CRON', '0 0/10 * * * ?', 'DO_NOTHING', 'ROUND', 'flushAnyTenantDeviceCacheJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2025-03-30 19:57:24', '', 1, 0, 1762073400000);
INSERT INTO `xxl_job_info` (`id`, `job_group`, `job_desc`, `add_time`, `update_time`, `author`, `alarm_email`, `schedule_type`, `schedule_conf`, `misfire_strategy`, `executor_route_strategy`, `executor_handler`, `executor_param`, `executor_block_strategy`, `executor_timeout`, `executor_fail_retry_count`, `glue_type`, `glue_source`, `glue_remark`, `glue_updatetime`, `child_jobid`, `trigger_status`, `trigger_last_time`, `trigger_next_time`) VALUES (4, 1, '刷新所有租户产品缓存', '2025-03-30 19:58:19', '2025-09-27 21:43:53', 'mqttsnet', '', 'CRON', '0 0/5 * * * ?', 'DO_NOTHING', 'ROUND', 'flushAnyTenantProductCacheJobHandler', '', 'SERIAL_EXECUTION', 0, 1, 'BEAN', '', 'GLUE代码初始化', '2025-03-30 19:58:19', '', 1, 1762073100000, 1762073400000);
INSERT INTO `xxl_job_info` (`id`, `job_group`, `job_desc`, `add_time`, `update_time`, `author`, `alarm_email`, `schedule_type`, `schedule_conf`, `misfire_strategy`, `executor_route_strategy`, `executor_handler`, `executor_param`, `executor_block_strategy`, `executor_timeout`, `executor_fail_retry_count`, `glue_type`, `glue_source`, `glue_remark`, `glue_updatetime`, `child_jobid`, `trigger_status`, `trigger_last_time`, `trigger_next_time`) VALUES (5, 1, '刷新所有租户产品模型缓存', '2023-10-21 21:43:54', '2025-09-27 21:43:58', 'mqttsnet', '', 'CRON', '0 0/5 * * * ?', 'DO_NOTHING', 'ROUND', 'flushAnyTenantProductModelCacheJobHandler', '', 'SERIAL_EXECUTION', 0, 3, 'BEAN', '', 'GLUE代码初始化', '2023-10-21 21:43:54', '', 1, 1762073100000, 1762073400000);
INSERT INTO `xxl_job_info` (`id`, `job_group`, `job_desc`, `add_time`, `update_time`, `author`, `alarm_email`, `schedule_type`, `schedule_conf`, `misfire_strategy`, `executor_route_strategy`, `executor_handler`, `executor_param`, `executor_block_strategy`, `executor_timeout`, `executor_fail_retry_count`, `glue_type`, `glue_source`, `glue_remark`, `glue_updatetime`, `child_jobid`, `trigger_status`, `trigger_last_time`, `trigger_next_time`) VALUES (10, 1, '执行所有租户OTA远程升级任务', '2024-03-06 16:22:43', '2025-11-02 16:42:02', 'mqttsnet', '', 'CRON', '0 0/5 * * * ?', 'DO_NOTHING', 'FIRST', 'processOtaUpgradeTasksJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2024-03-06 16:22:43', '', 1, 1762073100000, 1762073400000);
INSERT INTO `xxl_job_info` (`id`, `job_group`, `job_desc`, `add_time`, `update_time`, `author`, `alarm_email`, `schedule_type`, `schedule_conf`, `misfire_strategy`, `executor_route_strategy`, `executor_handler`, `executor_param`, `executor_block_strategy`, `executor_timeout`, `executor_fail_retry_count`, `glue_type`, `glue_source`, `glue_remark`, `glue_updatetime`, `child_jobid`, `trigger_status`, `trigger_last_time`, `trigger_next_time`) VALUES (33, 1, '刷新所有租户规则脚本缓存', '2025-03-29 21:48:53', '2025-11-02 16:42:05', 'mqttsnet', '', 'CRON', '0 0/10 * * * ?	', 'DO_NOTHING', 'ROUND', 'flushAnyTenantGroovyScriptCacheJobHandler', '', 'SERIAL_EXECUTION', 0, 3, 'BEAN', '', 'GLUE代码初始化', '2025-03-29 21:48:53', '', 1, 0, 1762073400000);
INSERT INTO `xxl_job_info` (`id`, `job_group`, `job_desc`, `add_time`, `update_time`, `author`, `alarm_email`, `schedule_type`, `schedule_conf`, `misfire_strategy`, `executor_route_strategy`, `executor_handler`, `executor_param`, `executor_block_strategy`, `executor_timeout`, `executor_fail_retry_count`, `glue_type`, `glue_source`, `glue_remark`, `glue_updatetime`, `child_jobid`, `trigger_status`, `trigger_last_time`, `trigger_next_time`) VALUES (35, 1, '刷新全租户设备ACL规则缓存', '2025-06-14 00:06:02', '2025-11-02 16:42:46', 'mqttsnet', '', 'CRON', '0 0/5 * * * ?	', 'DO_NOTHING', 'ROUND', 'flushAllTenantDeviceAclRuleCacheJobHandler', '', 'SERIAL_EXECUTION', 0, 3, 'BEAN', '', 'GLUE代码初始化', '2025-06-14 00:06:02', '', 1, 1762073100000, 1762073400000);
INSERT INTO `xxl_job_info` (`id`, `job_group`, `job_desc`, `add_time`, `update_time`, `author`, `alarm_email`, `schedule_type`, `schedule_conf`, `misfire_strategy`, `executor_route_strategy`, `executor_handler`, `executor_param`, `executor_block_strategy`, `executor_timeout`, `executor_fail_retry_count`, `glue_type`, `glue_source`, `glue_remark`, `glue_updatetime`, `child_jobid`, `trigger_status`, `trigger_last_time`, `trigger_next_time`) VALUES (84, 1, '同步所有租户设备连接状态', '2024-07-22 19:51:18', '2025-11-02 16:42:08', 'mqttsnet', '', 'CRON', '0 0/10 * * * ?', 'DO_NOTHING', 'ROUND', 'syncAnyTenantDeviceConnectionStatusJobHandler', '', 'SERIAL_EXECUTION', 0, 3, 'BEAN', NULL, NULL, '2024-07-22 19:51:18', '', 1, 0, 1762073400000);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=6142718 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
